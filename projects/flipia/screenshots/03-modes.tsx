// Template: Flipia tight — 3 modes (real capture: mode.jpg)
...
export default function Modes({ lang }: { lang?: string }) {
  ...
  return (
    <FlipiaLayout
      ...
      mockup={
        <AppMockup
          src="/api/assets/flipia/mode.jpg"
